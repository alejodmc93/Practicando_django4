...
urlpatterns = [
	...
	url(r'^registrar/$', views.RegistrarRestaurante.as_view(), name='registrar_restaurante'),
	...
	url(r'^reportar/$', views.EliminarRestaurante.as_view(), name='eliminar_restaurante'),
